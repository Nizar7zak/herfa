    ...
    return (
        ...
        <form onSubmit={ onSubmit } className="space-y-5 flex flex-col items-end w-full">
            ...
            <button
                ...
                className="w-[40%] py-4 bg-active hover:bg-primary  text-primary hover:text-secondary hover:text-white font-bold rounded-md transition-colors duration-300 disabled:opacity-50"
            >
                إرســــــــال
            </button>
