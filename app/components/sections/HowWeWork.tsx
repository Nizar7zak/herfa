...
const HowWeWork = () => {
  ...
  return (
    <section id="آلية-عملنا" className="h-screen md:w-[182vw] xl:w-[178vw] 2xl:w-[168vw] 3xl:w-[148vw] flex justify-center items-center gap-10 xl:gap-16 2xl:gap-24 3xl:gap-32">
      <div>
